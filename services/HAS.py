...
class HomeAssistantService:
	...
	def __init__(self, language, hardware):
		...
		#################################################
		############# Debug
		self.things["devices"]["ventilador"] = IoTDevice.from_json('{"alias": "ventilador", "address": "192.168.1.50", "mac": "FF:FF:FF:00:00:00", "category": "Temperature", "properties": {"status": {"value": "off"} }, "intents": [ { "turn on": { "request": "http://{ipaddress}/?relay={status}}", "parameters": { "method": "get", "type": "string", "action": "set", "ipaddress": "255.255.255.255", "status": "on" } } }, { "turn off": { "request": "http://{ipaddress}/?relay={status}", "parameters": { "method": "get", "type": "string", "action": "set", "ipaddress": "255.255.255.255", "status": "off" } } } ]}') # Switch("192.168.1.50", "FF:FF:FF:00:00:00", "ventilador")
		self.things["devices"]["bombilla"] = IoTDevice.from_json('{"alias": "bombilla", "address": "192.168.1.51", "mac": "FF:FF:FF:00:00:01", "category": "Light", "properties": {"status": {"value": "off"}, "color": {"value": "#000000"}, "intensity": {"value": 100, "min": 10, "max": 100} }, "intents": [ { "turn on": { "request": "http://{ipaddress}/?relay={status}}", "parameters": { "method": "get", "type": "string", "action": "set", "ipaddress": "255.255.255.255", "status": "on" } } }, { "turn off": { "request": "http://{ipaddress}/?relay={status}", "parameters": { "method": "get", "type": "string", "action": "set", "ipaddress": "255.255.255.255", "status": "off" } } }, { "color set": { "request": "http://{ipaddress}/?color={color}", "parameters": { "method": "get", "type": "string", "action": "set", "ipaddress": "255.255.255.255", "color": "#000000" } } }, { "intensity set": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "ipaddress": "255.255.255.255", "intensity": 0 } } }, { "increase intensity": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "ipaddress": "255.255.255.255", "intensity": 10 } } }, { "decrease intensity": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "ipaddress": "255.255.255.255", "intensity": -10 } } }, { "intensity up": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "ipaddress": "255.255.255.255", "intensity": 10 } } }, { "intensity down": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "ipaddress": "255.255.255.255", "intensity": -10 } } }, { "intensity max": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "ipaddress": "255.255.255.255", "intensity": 100 } } }, { "intensity min": { "request": "http://{ipaddress}/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "ipaddress": "255.255.255.255", "intensity": 10 } } } ]}')# Bolb("192.168.1.51", "AF:AF:AF:00:00:00", "bombilla")
