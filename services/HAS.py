...
class HomeAssistantService:
	...
	def __init__(self, language, hardware):
		...
		#################################################
		############# Debug
		self.things["devices"]["ventilador"] = IoTDevice.from_json('{"alias": "ventilador", "address": "192.168.1.50", "mac": "FF:FF:FF:00:00:00", "category": "Temperature", "properties": {"status": {"value": "off"} }, "intents": [ { "turn on": { "function": "request", "argument": "http://[##ipaddress##]/?relay={status}}", "parameters": { "method": "get", "type": "string", "action": "set", "status": "on" } } }, { "turn off": { "function": "request", "argument": "http://[##ipaddress##]/?relay={status}", "parameters": { "method": "get", "type": "string", "action": "set", "status": "off" } } } ]}') # Switch("192.168.1.50", "FF:FF:FF:00:00:00", "ventilador")
		self.things["devices"]["bombilla"] = IoTDevice.from_json('{"alias": "bombilla", "address": "192.168.1.51", "mac": "FF:FF:FF:00:00:01", "category": "Light", "properties": {"status": {"value": "off"}, "color": {"value": "#000000"}, "intensity": {"value": 100, "min": 10, "max": 100} }, "intents": [ { "turn on": { "function": "request", "argument": "http://[##ipaddress##]/?relay={status}}", "parameters": { "method": "get", "type": "string", "action": "set", "status": "on" } } }, { "turn off": { "function": "request", "argument": "http://[##ipaddress##]/?relay={status}", "parameters": { "method": "get", "type": "string", "action": "set", "status": "off" } } }, { "color set": { "function": "request", "argument": "http://[##ipaddress##]/?color={color}", "parameters": { "method": "get", "type": "string", "action": "set", "color": "#000000" } } }, { "intensity set": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "intensity": 0 } } }, { "increase intensity": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "intensity": 10 } } }, { "decrease intensity": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "intensity": -10 } } }, { "intensity up": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "intensity": 10 } } }, { "intensity down": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "add", "intensity": -10 } } }, { "intensity max": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "intensity": 100 } } }, { "intensity min": { "function": "request", "argument": "http://[##ipaddress##]/?intensity={intensity}", "parameters": { "method": "get", "type": "integer", "action": "set", "intensity": 10 } } } ]}')# Bolb("192.168.1.51", "AF:AF:AF:00:00:00", "bombilla")
